...
export const TabSystem: React.FC<TabSystemProps> = ({
  ...
  return (
    <>
      <div className="flex flex-col h-full w-[260px] bg-[#050505] border-r border-white/5 z-10 text-zinc-400 font-sans select-none">
        
        {/* Window Controls & Workspace Switcher Combined */}
        <div className="pt-5 pb-2 px-4 flex flex-col gap-4">
            ...
            <div className="flex items-center gap-1">
                ...
                editingId === ws.id && editType === 'workspace' ? (
                    ...
                    className={`flex-1 h-8 flex items-center justify-center rounded-lg text-xs font-medium transition-all duration-300 relative group ${
                ...
                <button
                    ...
                    className="h-8 w-8 flex items-center justify-center rounded-lg text-zinc-600 hover:text-zinc-200 hover:bg-white/5 transition-colors"
        ...
        {/* Separator */}
        <div className="h-px w-full bg-gradient-to-r from-transparent via-white/5 to-transparent my-2"></div>
        ...
        <div className="flex-1 overflow-y-auto px-2 space-y-1 scrollbar-none">
          {tabs.map((tab) => {
            ...
            <div
              ...
              className={`group relative flex items-center h-9 px-3 rounded-lg cursor-pointer transition-all duration-200 ${
                isActive
            ...
            >
              ...
              <button
                ...
                className={`absolute right-2 p-1 rounded-md text-zinc-500 hover:text-white hover:bg-white/10 transition-all ${
        ...
        <div className="p-4 mt-auto">
          <button
            onClick={onTabCreate}
            className="w-full flex items-center justify-center space-x-2 h-10 rounded-xl border border-white/5 bg-white/5 hover:bg-white/10 text-zinc-400 hover:text-white transition-all duration-300 text-xs font-medium group"
          >
