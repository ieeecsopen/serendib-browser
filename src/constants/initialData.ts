...
import type { Bookmark, Workspace, Container, DownloadItem, Extension } from '../types';
...
export const INITIAL_CONTAINERS: Container[] = [
  { id: 'cont-default', name: 'Personal', color: '#3b82f6', icon: 'User', isDisposable: false },
  { id: 'cont-work', name: 'Work', color: '#f97316', icon: 'Briefcase', isDisposable: false },
  { id: 'cont-banking', name: 'Banking', color: '#22c55e', icon: 'DollarSign', isDisposable: false },
  { id: 'cont-shopping', name: 'Shopping', color: '#ec4899', icon: 'ShoppingBag', isDisposable: false },
];
...
export const MOCK_DOWNLOADS: DownloadItem[] = [
  ...
  { 
    ...
    url: 'https://finance.lk/reports', 
    totalBytes: 4500000, 
    receivedBytes: 2100000, 
    state: 'progressing', 
    startTime: Date.now() - 2000 
  },
  { 
    id: 'd3', 
    filename: 'image_pack.zip', 
    url: 'https://images.com/pack', 
...
export const MOCK_EXTENSIONS: Extension[] = [
  ...
  { 
    ...
    description: 'Adds React debugging tools to the Developer Tools.', 
    version: '4.28.0', 
    icon: 'Code', 
    enabled: false, 
...
export const MOCK_SEARCH_RESULTS = [
  { 
    ...
    snippet: "Sri Lanka, officially the Democratic Socialist Republic of Sri Lanka, is an island country in South Asia, located in the Indian Ocean southwest of the Bay of Bengal." 
  },
  { 
    title: "Sri Lanka Tourism - The Official Website", 
    url: "https://www.srilanka.travel", 
    snippet: "Welcome to Sri Lanka. See what's waiting for you. Travel info, attractions, culture, and more." 
  },
  { 
    title: "News 1st: Sri Lanka News", 
    url: "https://www.newsfirst.lk", 
    snippet: "Get the latest breaking news and top stories from Sri Lanka and around the world." 
  },
];
