...
export const BUILT_IN_THEMES: Record<string, CustomTheme> = {
  ...
  Seran: {
    ...
    colors: {
      ...
      bgActive: 'rgba(217, 119, 6, 0.2)',
      textPrimary: '#fef3c7',
      textSecondary: '#fcd34d',
      textMuted: '#92400e',
      borderPrimary: 'rgba(217, 119, 6, 0.25)',
      borderSecondary: 'rgba(217, 119, 6, 0.12)',
      accent: '#d97706',
      accentHover: '#b45309',
      accentMuted: 'rgba(217, 119, 6, 0.2)',
      success: '#059669',
      warning: '#f59e0b',
      error: '#dc2626',
      info: '#0891b2',
  ...
  ceylon: {
    ...
    colors: {
      ...
      textSecondary: '#86efac',
      textMuted: '#166534',
      borderPrimary: 'rgba(22, 163, 74, 0.25)',
      borderSecondary: 'rgba(22, 163, 74, 0.12)',
      accent: '#16a34a',
      accentHover: '#15803d',
      accentMuted: 'rgba(22, 163, 74, 0.2)',
      success: '#22c55e',
      warning: '#eab308',
      error: '#ef4444',
      info: '#06b6d4',
      shadow: 'rgba(22, 163, 74, 0.3)',
      overlay: 'rgba(10, 18, 10, 0.9)',
    },
  },
  ...
  ocean: {
    ...
    colors: {
      ...
      borderSecondary: 'rgba(14, 165, 233, 0.12)',
      accent: '#0ea5e9',
      accentHover: '#0284c7',
